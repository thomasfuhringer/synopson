...
{
    setWindowTitle(tr("Synopson")); // necessary since Qt5
    setUnifiedTitleAndToolBarOnMac(true);
    createActionsAndMenus();

    settings = new QSettings("Free Software", "Synopson");
...
void MainWindow::showAboutBox()
{
    QMessageBox::about(this, tr("About Synopson"),
                       tr("<h2>Synopson</h2>"
                          ...
                          "<p><em>Version 0.9.1</em>"
                          "<p>File Manager<br>"
                          "https://github.com/thomasfuhringer/synopson<br>"
